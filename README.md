# nm-visualiser
A simple numerical analysis tool which can perform differentiation, integration and root approximation for functions using a multitude of methods. For description of each of these methods, refer to [Numerical Analysis](https://github.com/avaniii17/nm-visualiser/blob/main/Numerical-Analysis-Tool.pdf).
